...
export 'package:kixflagship/kixflagship.dart';
export 'package:aqueduct/test.dart';
export 'package:test/test.dart';
export 'package:aqueduct/aqueduct.dart';

/// A testing harness for kixflagship.
///
/// Use instances of this class to start/stop the test kixflagship server. Use [client] to execute
...
class TestApplication {
  Application<KixflagshipSink> application;
  KixflagshipSink get sink => application.mainIsolateSink;
  TestClient client;

  /// Starts running this test harness.
  ///
  /// This method will start an [Application] with [KixflagshipSink].
  /// The declared [ManagedObject]s in this application will be
  /// used to generate a temporary database schema. The [KixflagshipSink] instance will use
  ...
  Future start() async {
    ...
    application = new Application<KixflagshipSink>();
